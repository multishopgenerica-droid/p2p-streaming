    ...
    <div className="container mx-auto px-6 pt-10 pb-20">
      <div className="w-full max-w-4xl mx-auto bg-[#FF6B00] rounded-[2.5rem] p-10 md:p-16 text-center shadow-[0_0_80px_rgba(255,107,0,0.2)] relative overflow-hidden group">
        ...
        <div className="relative z-10">
          ...
          <button className="bg-[#00E676] text-black font-black text-lg md:text-xl py-5 px-10 rounded-full shadow-xl hover:scale-105 hover:bg-[#00c853] transition-all flex items-center justify-center gap-3 mx-auto w-full md:w-auto uppercase tracking-wide">
